...
* The original package name 'guru.springframework.spring-6-auth-server' is invalid and this project uses 'guru.springframework.spring_6_auth_server' instead.
